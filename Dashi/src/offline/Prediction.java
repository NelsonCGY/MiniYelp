...
public class Prediction {
	...
	public static void main(String[] args) {
		...
		// System.out.println("\n\n\n");
		PriorityQueue<User> mostSimilarUsers = new PriorityQueue<User>();
		for (User user : similarUsers) {
			mostSimilarUsers.add(user);
		}

		printList(mostSimilarUsers);
	...
	private static void printList(PriorityQueue<User> mostSimilarUsers) {
		while (!mostSimilarUsers.isEmpty()) {
			User user = mostSimilarUsers.poll();
